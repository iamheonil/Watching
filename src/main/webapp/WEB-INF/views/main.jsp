		...
		<div id="loginForm">
			...
			<form action="#" method="post">
               ...
               <br>
                ...
                <label>아이디 &nbsp; <input style="width: 60%; min-height: 25px;" type="text" name="uid" ></label><br><br>
                <label>패스워드 <input style="width: 60%; min-height: 25px;" type="password" name="upw"></label>
			...
			<div style="width: 500px; margin-left: 200px;">
			    <a href="#">회원정보 찾기</a> | <b><a href="#">개인정보처리방침</a></b> | <a href="#">이용약관</a> | &copy; HI 
			    </div>
		</div>
	</div>
